...
CLI, a headless Marlo, the `ocw` CLI from a second machine) presents the token
...
_TOKEN_PREFIX = "owb_"  # board token; the ow- prefix is upstream's wire value, kept as-is

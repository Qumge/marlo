...
from ..config import DEFAULT_MODEL, load_config, workspace_allowed_commands
from ..conversations import ConversationStore, title_from
from ..qumge.manager_mixin import QumgeManagerMixin
...
class SessionManager(QumgeManagerMixin):
    def __init__(
        self,
        *,
    ...
    def set_scratch_base(self, path: str) -> dict[str, Any]:
        ...
        created (default ~/Marlo). The raw value is stored so the UI shows it as entered;

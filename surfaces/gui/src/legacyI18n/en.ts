...
export const en = {
  ...
  skConfirmation: "— the worker can now use it in every conversation.",
  skTurnedOff: "turned off everywhere. If a conversation already used it, start a new one for a completely clean slate.",
  skRemoved: "removed. If a conversation already used it, start a new one for a completely clean slate.",
  skWentWrong: "Something went wrong.",
  skNewSkill: "New skill",
  skEditNamed: (name: string) => `Edit ${name}`,
  skInstructionsPlaceholder: "1. Gather last week's updates\n2. Write the report, under 300 words",
  skConfirmDelete: "Confirm delete",
  skBuildFor: (d: string) => `Build a new skill for me: ${d}`,
  skBuildPrompt: "Build a new skill for me: (describe what the skill should do)",
  trTriedSkill: "Tried skill: ",
  trNotAvailable: " — not available",
  apAddToSkills: "Add to my skills",
  apNotNow: "Not now",
  ...
  skAdd: "Add skill",
  skDoorWrite: "Write it myself",
  skDoorWriteSub: "A name, a description, and the instructions",
  skDoorImport: "Import a file",
  skDoorImportSub: "A .zip or SKILL.md someone shared — you review before it installs",
  skDoorMarlo: "Create with Marlo",
  skDoorMarloSub: "Starts a conversation — the worker builds it and asks before adding it to your skills",
  skUploadLabel: "Upload a skill archive",
  skReviewFirst: "Review before installing",
  skReviewLede: "Read the instructions — installing a skill means the worker will follow them.",
  skInstallBtn: "Install skill",
  skCancel: "Cancel",
  skFieldName: "Name",
  skFieldDesc: "Description",
  skFieldInstructions: "Instructions",
  skDescPlaceholder: "One line the worker uses to decide when this applies",
  skSave: "Save skill",
  skEdit: "Edit",
  skShowFolder: "Show folder",
  skFileCount: (n: number) => `${n} file${n === 1 ? "" : "s"}`,
  skOn: "On",
  skNoDescription: "no description",
  skBundledFiles: "Bundled files:",
  ...
  glAllPersonas: "All coworkers",
  glCuratedNote: "Curated coworkers · installs stay disabled until you approve them",
  uiDone: "Done",
  glFeatured: "Featured",
  glTeamEmpty: "From your team — nothing shared yet. Publishing a coworker to your teammates is coming soon.",
  ...
  tplLeavesMac: (target: string) => `leaves this computer → ${target}`,
  ...
  tplInstalledPersonas: (n: number) => `Installed ${n} coworker(s) — review and enable below.`,
  ...
  scStaysOnMac: "stays on this computer",
  ...
  tplQumgeHttpError: (code: string) => `Qumge returned an unexpected error (HTTP ${code}).`,
  ...
  setPersonasLede: "Which coworkers are enabled and shown in the picker, plus installing new coworker bundles.",
  ...
  glNoMatch: "No coworkers match your search.",
  glNonePublished: "No coworkers published yet.",
  ...
  icQuestionN: (n: number) => `Question ${n}`,
  ...
  qcTooManyAttempts: "Too many sign-in attempts — Qumge allows a few per hour. Wait a bit and try again.",
  qcCantReachQumge: "Couldn’t reach Qumge — check your network and try again.",
  ...
  pvLoadFailed: "Could not load this coworker.",
  ...
  navPersonas: "Coworkers",
  memEnabledMessage: "Details you share from future conversations will be remembered, so I can be more helpful over time.",
  memDisabledMessage: "I'll stop remembering new things about you. What I already know is kept and still used — delete anything below you'd rather I forget.",
  memDeleteAllConfirm: "Delete everything that's been remembered about you?\n\nThis can't be undone. Conversations you already have open still know what they knew — new conversations start with a clean slate.",
  memDeleteAllDone: "Everything I remembered has been deleted. New conversations start fresh; ones you already have open still know what they knew when they started.",
  memLede: "Your coworkers can remember useful things about you between conversations. Everything they know is listed here.",
  memRulesLede: "Your coworkers follow these in every conversation.",
  memRulesPlaceholder: "I use a screen reader — no tables, describe any image\nUse DD-MM-YYYY for dates",
  filterAll: "All",

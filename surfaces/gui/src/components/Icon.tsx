...
export function Icon({
  ...
  switch (name) {
    ...
    case "gear":
      return (
        <svg {...s}>
          {/* 对称六齿，用几何算出来的（齿顶 R=10、齿根 R=7.6，半角 13°/17°）。
              上一版是手写路径，六个齿的弧线首尾接不上，渲染出来缺一块、歪着
              —— owner 拿它和别的 app 一对比就看出来了。 */}
          <path d="M 9.75 2.26 A 10.0 10.0 0 0 1 14.25 2.26 L 14.22 4.73 A 7.6 7.6 0 0 1 17.18 6.44 L 19.31 5.18 L 19.31 5.18 A 10.0 10.0 0 0 1 21.56 9.08 L 19.41 10.29 A 7.6 7.6 0 0 1 19.41 13.71 L 21.56 14.92 L 21.56 14.92 A 10.0 10.0 0 0 1 19.31 18.82 L 17.18 17.56 A 7.6 7.6 0 0 1 14.22 19.27 L 14.25 21.74 L 14.25 21.74 A 10.0 10.0 0 0 1 9.75 21.74 L 9.78 19.27 A 7.6 7.6 0 0 1 6.82 17.56 L 4.69 18.82 L 4.69 18.82 A 10.0 10.0 0 0 1 2.44 14.92 L 4.59 13.71 A 7.6 7.6 0 0 1 4.59 10.29 L 2.44 9.08 L 2.44 9.08 A 10.0 10.0 0 0 1 4.69 5.18 L 6.82 6.44 A 7.6 7.6 0 0 1 9.78 4.73 L 9.75 2.26 Z" />

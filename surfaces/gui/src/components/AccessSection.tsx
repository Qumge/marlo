...
const BTN_ACCENT =
  "self-stretch inline-flex items-center justify-center text-meta px-2.5 py-1.5 rounded-lg " +
...
function ChannelsInline({
  ...
  const where = held
    ? held.holder.machine_id === "desktop" || !held.holder.machine_id
      ...
      : machineNames[held.holder.machine_id] || t("onmachine.access.another_machine")
    : "";
  return (
    <div>
      <button

  ...
  return (
    <div className="relative">
      <button
        ...
        title={
          pct !== null
            ? tr("usage.chip_title_bar", { pct: pct as number, total: formatTokens(usage.context) })
          ...
          >
            {options.map((o) => (
              ...
              >
                ...
                <span className="text-[11px] text-faint leading-snug">{o.description ? t(o.description) : ""}</span>
              </button>
            ))}
            {onUnattendedChange && (
              <>

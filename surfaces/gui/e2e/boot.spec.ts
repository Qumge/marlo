// Cold-boot fixes (owner-hit 2026-07-23): the splash wears the real Marlo mark
...
test("boot splash shows the Marlo star, not the sparkle glyph", async ({ page }) => {
  ...
  await expect(page.getByText(/Starting Marlo|Restoring your session/)).toBeVisible();
});
